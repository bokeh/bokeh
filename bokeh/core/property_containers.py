...
class PropertyValueDict(PropertyValueContainer, dict):
    ...
    def _stream(self, doc, source, new_data, rollover=None, setter_id=None):
        ...
        self._notify_owners(old,
                            hint=ColumnsStreamedEvent(doc, source, new_data, rollover, setter_id))

    # notifies owners explicitly
    def _patch(self, doc, source, patches, setter_id=None):
        ...
        self._notify_owners(old,
                            hint=ColumnsPatchedEvent(doc, source, patches, setter_id))
