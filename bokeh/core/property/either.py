...
class Either(ParameterizedProperty):
    ...
    def __init__(self, tp1, tp2, *type_params, default=Intrinsic, help=None, serialized=None, readonly=False, converts=None) -> None:
        ...
        super().__init__(default=default, help=help, serialized=serialized, readonly=readonly, converts=converts)
