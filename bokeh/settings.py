...
_config_user_locations = (join(expanduser("~"), ".bokeh", "bokeh.yaml"),)
...
class Settings(object):
    ...
    allowed_ws_origin = PrioritizedSetting(
        "allowed_ws_origin",
    ...
    auth_module = PrioritizedSetting(
        "auth_module",
        "BOKEH_AUTH_MODULE",
        default=None,
        help="""
    ...
    cookie_secret = PrioritizedSetting(
        "cookie_secret",
        "BOKEH_COOKIE_SECRET",
        default=None,
        help="""
    ...
    docs_version = PrioritizedSetting(
        "docs_version",
        "BOKEH_DOCS_VERSION",
        default=None,
        help="""
    ...
    ignore_filename = PrioritizedSetting(
        "ignore_filename",
    ...
    nodejs_path = PrioritizedSetting(
        "nodejs_path",
        "BOKEH_NODEJS_PATH",
        default=None,
        help="""
    ...
    perform_document_validation = PrioritizedSetting(
        "validate_doc",
        "BOKEH_VALIDATE_DOC",
        convert=convert_bool,
        default=True,
    ...
    phantomjs_path = PrioritizedSetting(
        "phantomjs_path",
    ...
    py_log_level = PrioritizedSetting(
        "py_log_level",
        "BOKEH_PY_LOG_LEVEL",
        default="none",
        dev_default="debug",
    ...
    sign_sessions = PrioritizedSetting(
        "sign_sessions",
        "BOKEH_SIGN_SESSIONS",
        default=False,
        help="""
    ...
    ssl_certfile = PrioritizedSetting(
        "ssl_certfile",
        "BOKEH_SSL_CERTFILE",
        default=None,
        help="""
    ...
    ssl_keyfile = PrioritizedSetting(
        "ssl_keyfile",
        "BOKEH_SSL_KEYFILE",
        default=None,
        help="""
    ...
    ssl_password = PrioritizedSetting(
        "ssl_password",
        "BOKEH_SSL_PASSWORD",
        default=None,
        help="""
    ...
    xsrf_cookies = PrioritizedSetting(
        "xsrf_cookies",
        "BOKEH_XSRF_COOKIES",
        default=False,
        convert=convert_bool,
