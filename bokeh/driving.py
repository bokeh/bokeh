...
def bounce(sequence: Sequence[int]) -> Callable:
...
def force(f: Callable, sequence: Generator) -> Callable[[], None]:
...
def repeat(sequence: Sequence[int]) -> Callable:
...
def _advance(f: Callable) -> Generator:
