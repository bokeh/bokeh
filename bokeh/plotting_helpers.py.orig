...
<<<<<<< HEAD
        ResetTool, ResizeTool, WheelZoomTool, CategoricalAxis, FactorRange, PinchZoomTool, PinchBoxZoomTool)
=======
...
def _new_xy_plot(x_range=None, y_range=None, plot_width=None, plot_height=None,
                 ...
                 tools="pan,wheel_zoom,box_zoom,save,resize,select,reset,pinch_zoom,pinch_box_zoom", **kw):
