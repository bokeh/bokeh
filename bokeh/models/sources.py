...
class ColumnDataSource(ColumnarDataSource):
    ...
    * A Pandas ``GroupBy`` object
    ...
    """,
        ...
        .accepts(PandasDataFrame, lambda x: ColumnDataSource._data_from_df(x))
        .accepts(PandasGroupBy, lambda x: ColumnDataSource._data_from_groupby(x))
        .asserts(
