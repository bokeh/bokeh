...
class ColorBar(Annotation):
    ...
    formatter = Instance(
        TickFormatter,
        default=lambda: BasicTickFormatter(),
        help="""
...
class Band(Annotation):
    ...
    source = Instance(
        DataSource,
        default=lambda: ColumnDataSource(),
        help="""
    Local data source to use when rendering annotations on the plot.
    """,
    )
