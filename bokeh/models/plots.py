...
class _list_attr_splat(list):
    ...
    def __getattribute__(self, attr):
        ...
        try:
            ...
            raise AttributeError(
                "Trying to access %r attribute on a 'splattable' list, but list items have no %r attribute"
                % (attr, attr)
            )
