...
__all__ = ("NextTickCallback", "PeriodicCallback", "SessionCallback", "TimeoutCallback")
...
class _DocumentCallbackGroup(object):
    ...
    def add_session_callback(self, callback_obj):
        ...
        if isinstance(callback_obj, PeriodicCallback):
            ...
            raise ValueError(
                "Expected callback of type PeriodicCallback, TimeoutCallback, NextTickCallback, got: %s"
