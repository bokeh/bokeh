...
(function() {
  ...
  Bokeh.bar_plot = function(parent, data_source, xfield, yfield, orientation, local) {
    var bar_plot, options, plot_model, xaxis, xdr, xmapper, yaxis, ydr, ymapper, _ref, _ref1;
    if (_.isUndefined(local)) {
      local = true;
    }
    options = {
    ...
    _ref1 = Bokeh.make_range_and_mapper(data_source, [yfield], d3.max([1 / (data_source.get('data').length - 1), 0.1]), plot_model.get_ref('yrange'), false, options), ydr = _ref1[0], ymapper = _ref1[1];
