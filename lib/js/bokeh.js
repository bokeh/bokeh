...
(function() {
  ...
  XYRenderer = (function(_super) {
    ...
    XYRenderer.prototype.stopselect = function(options) {
      var source;
      source = this.get_ref('data_source');
  ...
  ScatterRendererView = (function(_super) {
    ...
    ScatterRendererView.prototype.initialize = function(options) {
      ...
      safebind(this, this.model, 'change', this.render);
      safebind(this, this.mget_ref('xmapper'), 'change', function() {
      ...
      return safebind(this, this.mget_ref('data_source'), 'change:selected', function() {
        var circles, newcircles;
        if (_this.mget_ref('data_source').get('selected') === null) {
          circles = _this.get_marks();
          _this.fill_marks(circles);
          newcircles = _this.get_new_marks(circles);
          _this.fill_marks(newcircles);
        }
        return null;
      });
    };
  ...
  SelectionToolView = (function(_super) {
    ...
    SelectionToolView.prototype._stop_selecting = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        renderer = _ref[_i];
        this.model.resolve_ref(renderer).stopselect(this.mget('data_source_options'));
      }
      this.selecting = false;
