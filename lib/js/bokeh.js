...
(function() {
  ...
  XYRenderer = (function(_super) {
    ...
    XYRenderer.prototype.select = function(xscreenbounds, yscreenbounds, options) {
      ...
      source.select([this.get('xfield'), this.get('yfield')], func, options);
      return null;
    };

    XYRenderer.prototype.unselect = function(options) {
      var source;
      source = this.get_ref('data_source');
  ...
  D3LinearAxisView = (function(_super) {
    ...
    D3LinearAxisView.prototype.initialize = function(options) {
      safebind(this, this.model, 'change', this.render);
      safebind(this, this.mget_ref('mapper'), 'change', this.render);
      return D3LinearAxisView.__super__.initialize.call(this, options);
    };
  ...
  LineRendererView = (function(_super) {
    ...
    LineRendererView.prototype.initialize = function(options) {
      safebind(this, this.model, 'change', this.render);
      safebind(this, this.mget_ref('xmapper'), 'change', this.render);
      safebind(this, this.mget_ref('ymapper'), 'change', this.render);
      safebind(this, this.mget_ref('data_source'), 'change', this.render);
  ...
  ScatterRendererView = (function(_super) {
    ...
    ScatterRendererView.prototype.initialize = function(options) {
      ...
      safebind(this, this.mget_ref('xmapper'), 'change', this.render);
      safebind(this, this.mget_ref('ymapper'), 'change', this.render);
      return safebind(this, this.mget_ref('data_source'), 'change', this.render);
    };
  ...
  PanToolView = (function(_super) {
    ...
    PanToolView.prototype.render = function() {
      var node,
        _this = this;
  ...
  ZoomToolView = (function(_super) {
    ...
    ZoomToolView.prototype.render = function() {
      var node,
        _this = this;
      node = this.tag_d3('mainsvg', this.plot_id);
      node.attr('pointer-events', 'all');
  ...
  SelectionToolView = (function(_super) {
    ...
    SelectionToolView.prototype.initialize = function(options) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        safebind(this, renderer, 'change', this.render);
        safebind(this, renderer.get_ref('xmapper'), 'change', this.render);
        safebind(this, renderer.get_ref('ymapper'), 'change', this.render);
        _results.push(safebind(this, renderer.get_ref('data_source'), 'change:data', this.render));
      }
      return _results;
    };
    ...
    SelectionToolView.prototype._start_selecting = function() {
      var renderer, x, y, _i, _len, _ref, _ref1;
      _ref = this.mouse_coords(), x = _ref[0], y = _ref[1];
      this.mset({
        'start_x': x,
        'start_y': y,
    ...
    SelectionToolView.prototype._select_data = function() {
      var renderer, xrange, yrange, _i, _j, _len, _len1, _ref, _ref1, _ref2, _results;
      ...
      for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
        renderer = _ref2[_j];
        _results.push(this.model.resolve_ref(renderer).select(xrange, yrange, this.mget('data_source_options')));
      }
      return _results;
    };
    ...
    SelectionToolView.prototype.render = function() {
      ...
      node.on("mousemove.selection", function() {
        if (d3.event.ctrlKey) {
          if (!_this.selecting) {
  ...
  SelectionTool = (function(_super) {
    ...
    SelectionTool.prototype.defaults = {
      renderers: [],
      select_x: true,
      select_y: true,
      data_source_options: {}
  ...
  ScatterSelectionOverlayView = (function(_super) {
    ...
    ScatterSelectionOverlayView.prototype.initialize = function(options) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        safebind(this, renderer.get_ref('xmapper'), 'change', this.render);
        safebind(this, renderer.get_ref('ymapper'), 'change', this.render);
        _results.push(safebind(this, renderer.get_ref('data_source'), 'change', this.render));
      }
      return _results;
    };

    ScatterSelectionOverlayView.prototype.render = function() {
      var idx, node, renderer, selected, temp, viewid, _i, _j, _len, _len1, _ref, _ref1,
        _this = this;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        renderer = this.model.resolve_ref(renderer);
        selected = {};
        if (renderer.get_ref('data_source').get('selected') === null) {
          continue;
        }
        ...
        if (renderer.get_ref('data_source').get('selected').length > 0) {
          console.log(node.selectAll(renderer.get('mark')).filter(function(d, i) {
            return !selected[i];
          }));
        }
      }
