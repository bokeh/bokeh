(function() {
  var Bokeh, BokehView, Collections, Component, D3LinearAxes, D3LinearAxis, D3LinearAxisView, DiscreteColorMapper, DiscreteColorMappers, FactorRange, FactorRanges, GridPlotContainer, GridPlotContainerView, HasParent, HasProperties, HasReference, LinearMapper, LinearMappers, Mapper, ObjectArrayDataSource, ObjectArrayDataSources, Plot, PlotView, Plots, Range1d, Range1ds, Renderer, ScatterRenderer, ScatterRendererView, ScatterRenderers, build_views,
  ...
  build_views = function(builder, view_storage, view_specs, options) {
  ...
  GridPlotContainerView = (function(_super) {
    ...
    GridPlotContainerView.prototype.layout_dimensions = function() {
      var col, col_widths, columns, maxdim, n, num_cols, row, row_heights;
      ...
      row_heights = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          row = _ref[_i];
          _results.push(maxdim('height', row));
        }
        return _results;
      }).call(this);
      num_cols = this.mget('children')[0].length;
      columns = (function() {
        var _i, _len, _ref, _results;
      ...
      col_widths = (function() {
        ...
        for (_i = 0, _len = columns.length; _i < _len; _i++) {
          col = columns[_i];
          _results.push(maxdim('width', col));
        }
        return _results;
      })();
