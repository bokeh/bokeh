...
(function() {
  ...
  PlotRange1d = (function(_super) {
    ...
    PlotRange1d.name = 'PlotRange1d';

    function PlotRange1d() {
      return PlotRange1d.__super__.constructor.apply(this, arguments);
    }
  ...
  PlotRange1ds = (function(_super) {
    ...
    PlotRange1ds.name = 'PlotRange1ds';

    function PlotRange1ds() {
      return PlotRange1ds.__super__.constructor.apply(this, arguments);
    }
  ...
  Bokeh.scatter_plot = function(parent, data_source, xfield, yfield, color_field, mark, colormapper) {
    var color_mapper, plot_model, scatter_plot, source_name, xaxis, xdr, xmapper, xr, yaxis, ydr, ymapper, yr;
  ...
  Bokeh.line_plot = function(parent, data_source, xfield, yfield) {
    var line_plot, plot_model, source_name, xaxis, xdr, xmapper, xr, yaxis, ydr, ymapper, yr;
    source_name = data_source.get('name');
    plot_model = Collections['Plot'].create({
      data_sources: {
        source_name: data_source.ref()
