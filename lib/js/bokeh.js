...
(function() {
  ...
  SelectionToolView = (function(_super) {
    ...
    SelectionToolView.prototype._start_selecting = function() {
      var renderer, x, y, _i, _len, _ref, _ref1, _ref2;
      _ref = this.mouse_coords(), x = _ref[0], y = _ref[1];
      _ref1 = [x, y], this.start_x = _ref1[0], this.start_y = _ref1[1];
    ...
    SelectionToolView.prototype._selecting = function() {
      var height, node, renderer, width, x, xrange, y, yrange, _i, _len, _ref, _ref1;
      _ref = this.mouse_coords(), x = _ref[0], y = _ref[1];
      if (this.mget('select_x')) {
        xrange = [d3.min([this.start_x, x]), d3.max([this.start_x, x])];
      } else {
        xrange = null;
      }
      if (this.mget('select_y')) {
        yrange = [d3.min([this.start_y, y]), d3.max([this.start_y, y])];
      } else {
        yrange = null;
      }
