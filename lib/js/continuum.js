...
(function() {
  var Collections, Continuum, ContinuumView, HasParent, HasProperties, HasReference, Table, TableView, Tables, safebind,
    ...
    HasProperties.prototype.register_property = function(prop_name, dependencies, property, use_cache) {
      ...
      for (_i = 0, _len = dependencies.length; _i < _len; _i++) {
        ...
        if (prop_spec.use_cache) {
          safebind(this, this, "change:" + dep, this.properties[prop_name].invalidate_cache_callback);
        }
        _results.push(safebind(this, this, "change:" + dep, this.properties[prop_name].event_generator));
      }
      return _results;
    };
