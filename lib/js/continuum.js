...
(function() {
  var Collections, Continuum, ContinuumView, HasParent, HasProperties, Table, TableView, Tables, get_collections, logger, resolve_ref, safebind,
  ...
  Continuum.load_models = function(models) {
    var attrs, colls, model, type, _i, _len, _results;
    _results = [];
    for (_i = 0, _len = models.length; _i < _len; _i++) {
      ...
      type = model['type'];
      _results.push(colls[type].create(attrs));
    }
    return _results;
  };
