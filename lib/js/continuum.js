...
(function() {
  var Collections, Continuum, ContinuumView, HasParent, HasProperties, Table, TableView, Tables, logger, safebind,
  ...
  window.logger.on('all', function() {
    ...
    if (msg.indexOf('setcache') > 0 && msg.indexOf('Grid') > 0) {
      console.log(msg);
    }
  ...
  HasProperties = (function(_super) {
    ...
    HasProperties.prototype.register_property = function(prop_name, dependencies, getter, use_cache, setter) {
      ...
      prop_spec = {
        ...
        'callbacks': {
          'changedep': function() {
            logger.log('changedep:' + prop_name + _this.id);
            return _this.trigger('changedep:' + prop_name);
          },
          'invalidate_cache': function() {
            logger.log('clearcache:' + prop_name + _this.id);
            return _this.clear_cache(prop_name);
          },
          'eventgen': function() {
            logger.log('propchange:' + prop_name + _this.id);
      ...
      safebind(this, this, "changedep:" + prop_name, prop_spec['callbacks']['eventgen']);
    ...
    HasProperties.prototype.add_cache = function(prop_name, val) {
      logger.log('setcache:' + prop_name + val + this.id);
