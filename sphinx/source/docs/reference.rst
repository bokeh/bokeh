...
examples of Bokeh rendering plots from all of these libraries in the examples directory:

* `examples/ggplot <https://github.com/ContinuumIO/bokeh/tree/master/examples/ggplot>`_
* `examples/mpl <https://github.com/ContinuumIO/bokeh/tree/master/examples/mpl>`_
* `examples/pandas <https://github.com/ContinuumIO/bokeh/tree/master/examples/pandas>`_
* `examples/seaborn <https://github.com/ContinuumIO/bokeh/tree/master/examples/seaborn>`_
