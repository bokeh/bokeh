...
heading = Div(sizing_mode="stretch_width", height=80, text="In this wave example, the sliders on the left can be used to change the amplitude, frequency, phase and offset of the wave.")
