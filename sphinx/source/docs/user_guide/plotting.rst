...
.. bokeh-plot:: source/docs/user_guide/examples/plotting_line_steps.py
    :source-position: above
...
.. bokeh-plot:: source/docs/user_guide/examples/plotting_vbar.py
    :source-position: above
...
.. bokeh-plot:: source/docs/user_guide/examples/plotting_hbar.py
    :source-position: above
