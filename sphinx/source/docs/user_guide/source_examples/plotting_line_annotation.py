...
from bokeh.models import LineAnnotation

output_file("line_annotation.html", title="line_annotation.py example")
...
daylight_savings_start = LineAnnotation(location=dt(2013, 3, 31, 2, 0, 0).timestamp()*1000,
                                        dimension='height', line_color='green',
                                        line_dash='dashed',
                                        line_width=3)
daylight_savings_end = LineAnnotation(location=dt(2013, 10, 27, 3, 0, 0).timestamp()*1000,
