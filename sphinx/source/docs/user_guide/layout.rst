...
.. bokeh-plot:: source/docs/user_guide/examples/layout_vertical.py
...
.. bokeh-plot:: source/docs/user_guide/examples/layout_horizontal.py
    :source-position: above
...
.. bokeh-plot:: source/docs/user_guide/examples/layout_widgets.py
    :source-position: above
...
.. bokeh-plot:: source/docs/user_guide/examples/layout_grid.py
    :source-position: above
...
.. bokeh-plot:: source/docs/user_guide/examples/layout_grid_convenient.py
    :source-position: above
