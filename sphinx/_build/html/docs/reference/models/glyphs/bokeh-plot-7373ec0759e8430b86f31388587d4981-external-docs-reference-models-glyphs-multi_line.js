(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4e9bbd19-b85f-4140-ac52-5ce73c482e55");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4e9bbd19-b85f-4140-ac52-5ce73c482e55' but no matching script tag was found.")
        }
