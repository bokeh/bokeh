(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("bbc4aaf2-2ecd-4929-95b4-35a2c7f9c2b0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bbc4aaf2-2ecd-4929-95b4-35a2c7f9c2b0' but no matching script tag was found.")
        }
