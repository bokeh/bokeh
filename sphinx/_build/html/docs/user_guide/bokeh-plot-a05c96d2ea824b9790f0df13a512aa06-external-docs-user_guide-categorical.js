(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("86a9d121-39a2-4966-95b6-e87139d237d6");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '86a9d121-39a2-4966-95b6-e87139d237d6' but no matching script tag was found.")
        }
