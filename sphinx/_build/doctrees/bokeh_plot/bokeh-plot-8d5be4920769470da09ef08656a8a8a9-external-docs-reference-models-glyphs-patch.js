(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("9b65da40-38cb-49d3-886b-60d1ed050914");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '9b65da40-38cb-49d3-886b-60d1ed050914' but no matching script tag was found.")
        }
