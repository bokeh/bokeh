...
*/;
(function() {
  define('common/bulk_save',["underscore", "jquery"], function(_, $) {
    var bulk_save;
...
(function() {
  ...
  define('common/has_parent',["underscore", "./has_properties"], function(_, HasProperties) {
    var HasParent, _ref;
    return HasParent = (function(_super) {
...
(function() {
  ...
  define('common/plot',["underscore", "backbone", "require", "./build_views", "./safebind", "./bulk_save", "./continuum_view", "./has_parent", "./view_state", "mapper/1d/linear_mapper", "mapper/2d/grid_mapper", "renderer/properties", "tool/active_tool_manager"], function(_, Backbone, require, build_views, safebind, bulk_save, ContinuumView, HasParent, ViewState, LinearMapper, GridMapper, Properties, ActiveToolManager) {
    var LEVELS, Plot, PlotView, Plots, delay_animation, text_properties, throttle_animation, _ref, _ref1, _ref2;
  ...
  define('range/data_range1d',["underscore", "backbone", "range/range1d"], function(_, Backbone, Range1d) {
    ...
    DataRange1d = (function(_super) {
      ...
      DataRange1d.prototype._get_minmax = function() {
        var center, colname, columns, i, max, maxs, min, mins, source, sourceobj, span, _i, _j, _k, _len, _len1, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
        columns = [];
        ...
        if (!_.isArray(columns[0])) {
          ...
          for (i = _k = 0, _ref4 = columns.length - 1; 0 <= _ref4 ? _k <= _ref4 : _k >= _ref4; i = 0 <= _ref4 ? ++_k : --_k) {
          ...
          _ref5 = [_.min(mins), _.max(maxs)], min = _ref5[0], max = _ref5[1];
        }
        if (max !== min) {
...
(function() {
  ...
  define('renderer/glyph/glyph',["underscore", "common/has_parent", "common/plot_widget"], function(_, HasParent, PlotWidget) {
...
*/;
(function() {
  define('common/ticking',["underscore"], function(_) {
...
(function() {
  ...
  define('renderer/overlay/box_selection',["underscore", "common/has_parent", "common/plot_widget"], function(_, HasParent, PlotWidget) {
    ...
    BoxSelection.prototype.defaults = _.clone(BoxSelection.prototype.defaults);
    _.extend(BoxSelection.prototype.defaults, {
      tool: null,
      level: 'overlay'
    });
  ...
  define('source/column_data_source',["underscore", "backbone", "./object_array_data_source"], function(_, Backbone, ObjectArrayDataSource) {
    ...
    ColumnDataSource = (function(_super) {
      ...
      ColumnDataSource.prototype.datapoints = function() {
        ...
        fields = _.keys(data);
        points = [];
        for (i = _i = 0, _ref1 = data[fields[0]].length - 1; 0 <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
          point = {};
...
(function() {
  ...
  define('tool/zoom_tool',["underscore", "backbone", "./tool", "./event_generators"], function(_, Backbone, Tool, EventGenerators) {
    var OnePointWheelEventGenerator, ZoomTool, ZoomToolView, ZoomTools, _ref, _ref1, _ref2;
...
(function() {
  ...
  define('tool/box_select_tool',["underscore", "backbone", "./tool", "./event_generators"], function(_, Backbone, Tool, EventGenerators) {
    ...
    BoxSelectToolView = (function(_super) {
      ...
      BoxSelectToolView.prototype.mouse_coords = function(e, x, y) {
        var _ref1;
      ...
      BoxSelectToolView.prototype._get_selection_range_fast = function(current_x, current_y) {
        var xrange, yrange;
      ...
      BoxSelectToolView.prototype.box_selecting = function(e, x_, y_) {
        var x, y, _ref1, _ref2;
        _ref1 = this.mouse_coords(e, e.bokehX, e.bokehY), x = _ref1[0], y = _ref1[1];
    ...
    BoxSelectTool.prototype.defaults = _.clone(BoxSelectTool.prototype.defaults);
    _.extend(BoxSelectTool.prototype.defaults, {
      renderers: [],
      select_x: true,
      select_y: true,
      data_source_options: {}
...
(function() {
  ...
  define('tool/data_range_box_select_tool',["underscore", "backbone", "./box_select_tool"], function(_, Backbone, BoxSelectTool) {
    ...
    DataRangeBoxSelectTool.prototype.defaults = _.clone(DataRangeBoxSelectTool.prototype.defaults);
...
(function() {
  ...
  define('tool/preview_save_tool',["underscore", "backbone", "common/bulk_save", "./tool", "./event_generators"], function(_, Backbone, bulk_save, Tool, EventGenerators) {
...
define('vendor/text/text',['module'], function (module) {
...
(function() {
  ...
  define('widget/pandas/pandas_pivot_table',["underscore", "backbone", "common/has_parent", "common/continuum_view", "vendor/text/text!../../../template/pandaspivot.eco"], function(_, Backbone, HasParent, ContinuumView, pandaspivot) {
    ...
    PandasPivotTable.prototype.defaults = _.clone(PandasPivotTable.prototype.defaults);
    _.extend(PandasPivotTable.prototype.defaults, {
      sort: [],
      group: [],
      agg: 'sum',
      offset: 0,
...
(function() {
  ...
  define('renderer/glyph/annular_wedge',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var AnnularWedge, AnnularWedgeView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    ...
    AnnularWedgeView = (function(_super) {
      ...
      AnnularWedgeView.prototype.init_glyph = function(glyphspec) {
        var glyph_props;
        glyph_props = new glyph_properties(this, glyphspec, ['x', 'y', 'inner_radius', 'outer_radius', 'start_angle', 'end_angle', 'direction:string'], {
          fill_properties: new fill_properties(this, glyphspec),
          line_properties: new line_properties(this, glyphspec)
        });
        return glyph_props;
      };
...
(function() {
  ...
  define('renderer/glyph/annulus',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Annulus, AnnulusView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
    AnnulusView = (function(_super) {
      ...
      AnnulusView.prototype.init_glyph = function(glyphspec) {
        var glyph_props;
        glyph_props = new glyph_properties(this, glyphspec, ['x', 'y', 'inner_radius', 'outer_radius'], {
          fill_properties: new fill_properties(this, glyphspec),
          line_properties: new line_properties(this, glyphspec)
        });
        return glyph_props;
...
(function() {
  ...
  define('renderer/glyph/arc',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Arc, ArcView, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    ArcView = (function(_super) {
      ...
      ArcView.prototype.initialize = function(options) {
        ...
        this.glyph_props = new glyph_properties(this, glyphspec, ['x', 'y', 'radius', 'start_angle', 'end_angle', 'direction:string'], {
          line_properties: new line_properties(this, glyphspec)
        });
        this.do_stroke = this.glyph_props.line_properties.do_stroke;
...
(function() {
  ...
  define('renderer/glyph/asterisk',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Asterisk, AsteriskView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
    AsteriskView = (function(_super) {
      ...
      AsteriskView.prototype.init_glyph = function(glyphspec) {
        var glyph_props;
        glyph_props = new glyph_properties(this, glyphspec, ['x', 'y', 'size'], {
          fill_properties: new fill_properties(this, glyphspec),
          line_properties: new line_properties(this, glyphspec)
        });
        return glyph_props;
...
(function() {
  ...
  define('renderer/glyph/bezier',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Bezier, BezierView, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    BezierView = (function(_super) {
      ...
      BezierView.prototype.initialize = function(options) {
        var glyphspec;
        glyphspec = this.mget('glyphspec');
        this.glyph_props = new glyph_properties(this, glyphspec, ['x0', 'y0', 'x1', 'y1', 'cx0', 'cy0', 'cx1', 'cy1'], {
          line_properties: new line_properties(this, glyphspec)
        });
        this.do_stroke = this.glyph_props.line_properties.do_stroke;
...
(function() {
  ...
  define('renderer/glyph/circle',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Circle, CircleView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
    CircleView = (function(_super) {
      ...
      CircleView.prototype.init_glyph = function(glyphspec) {
        var glyph_props;
        glyph_props = new glyph_properties(this, glyphspec, ['x', 'y', 'radius'], {
          fill_properties: new fill_properties(this, glyphspec),
          line_properties: new line_properties(this, glyphspec)
        });
        return glyph_props;
...
(function() {
  ...
  define('renderer/glyph/circle_x',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var CircleX, CircleXView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
    CircleXView = (function(_super) {
      ...
      CircleXView.prototype._fast_path = function(ctx, glyph_props, use_selection) {
        var i, r, _i, _j, _ref1, _ref2, _results;
        if (!glyph_props) {
          glyph_props = this.glyph_props;
        }
        if (glyph_props.fill_properties.do_fill) {
...
(function() {
  ...
  define('renderer/glyph/circle_cross',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var CircleCross, CircleCrossView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
...
(function() {
  ...
  define('renderer/glyph/diamond',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Diamond, DiamondView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
...
(function() {
  ...
  define('renderer/glyph/diamond_cross',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var DiamondCross, DiamondCrossView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
...
(function() {
  ...
  define('renderer/glyph/image',["underscore", "renderer/properties", "mapper/color/linear_color_mapper", "palettes/palettes", "./glyph"], function(_, Properties, LinearColorMapper, Palettes, Glyph) {
    var ImageGlyph, ImageView, all_palettes, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
...
(function() {
  ...
  define('renderer/glyph/inverted_triangle',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var InvertedTriangle, InvertedTriangleView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
    InvertedTriangleView = (function(_super) {
      ...
      InvertedTriangleView.prototype._fast_path = function(ctx, glyph_props, use_selection) {
        var a, h, i, r, _i, _j, _ref1, _ref2, _results;
        if (!glyph_props) {
          glyph_props = this.glyph_props;
        }
        if (glyph_props.fill_properties.do_fill) {
...
(function() {
  ...
  define('renderer/glyph/line',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Line, LineView, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    LineView = (function(_super) {
      ...
      LineView.prototype.init_glyph = function(glyphspec) {
        var glyph_props;
        glyph_props = new glyph_properties(this, glyphspec, ['x:number', 'y:number'], {
          line_properties: new line_properties(this, glyphspec)
        });
        return glyph_props;
      };
...
(function() {
  ...
  define('renderer/glyph/multi_line',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var MultiLine, MultiLineView, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    MultiLineView = (function(_super) {
      ...
      MultiLineView.prototype.initialize = function(options) {
        var glyphspec;
        glyphspec = this.mget('glyphspec');
        this.glyph_props = new glyph_properties(this, glyphspec, ['xs:array', 'ys:array'], {
          line_properties: new line_properties(this, glyphspec)
        });
        this.do_stroke = this.glyph_props.line_properties.do_stroke;
...
(function() {
  ...
  define('renderer/glyph/oval',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Oval, OvalView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
    OvalView = (function(_super) {
      ...
      OvalView.prototype.init_glyph = function(glyphspec) {
        var glyph_props;
        glyph_props = new glyph_properties(this, glyphspec, ['x', 'y', 'width', 'height', 'angle'], {
          fill_properties: new fill_properties(this, glyphspec),
          line_properties: new line_properties(this, glyphspec)
        });
        return glyph_props;
...
(function() {
  ...
  define('renderer/glyph/patch',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Patch, PatchView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
    PatchView = (function(_super) {
      ...
      PatchView.prototype.initialize = function(options) {
        var glyphspec;
        glyphspec = this.mget('glyphspec');
        this.glyph_props = new glyph_properties(this, glyphspec, ['x:number', 'y:number'], {
          fill_properties: new fill_properties(this, glyphspec),
          line_properties: new line_properties(this, glyphspec)
        });
        this.do_fill = this.glyph_props.fill_properties.do_fill;
...
(function() {
  ...
  define('renderer/glyph/patches',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Patches, PatchesView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
...
(function() {
  ...
  define('renderer/glyph/cross',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Cross, CrossView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
...
(function() {
  ...
  define('renderer/glyph/quad',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Quad, QuadView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
    QuadView = (function(_super) {
      ...
      QuadView.prototype.initialize = function(options) {
        var glyphspec;
        glyphspec = this.mget('glyphspec');
        this.glyph_props = new glyph_properties(this, glyphspec, ['right', 'left', 'bottom', 'top'], {
          fill_properties: new fill_properties(this, glyphspec),
          line_properties: new line_properties(this, glyphspec)
        });
        this.do_fill = this.glyph_props.fill_properties.do_fill;
...
(function() {
  ...
  define('renderer/glyph/quadratic',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Quadratic, QuadraticView, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    QuadraticView = (function(_super) {
      ...
      QuadraticView.prototype.initialize = function(options) {
        var glyphspec;
        glyphspec = this.mget('glyphspec');
        this.glyph_props = new glyph_properties(this, glyphspec, ['x0', 'y0', 'x1', 'y1', 'cx', 'cy'], {
          line_properties: new line_properties(this, glyphspec)
        });
        this.do_stroke = this.glyph_props.line_properties.do_stroke;
...
(function() {
  ...
  define('renderer/glyph/ray',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Ray, RayView, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    RayView = (function(_super) {
      ...
      RayView.prototype.initialize = function(options) {
        var glyphspec;
        glyphspec = this.mget('glyphspec');
        this.glyph_props = new glyph_properties(this, glyphspec, ['x', 'y', 'angle', 'length'], {
          line_properties: new line_properties(this, glyphspec)
        });
        this.do_stroke = this.glyph_props.line_properties.do_stroke;
...
(function() {
  ...
  define('renderer/glyph/rect',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Rect, RectView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
...
(function() {
  ...
  define('renderer/glyph/square',["underscore", "renderer/properties", "./rect"], function(_, Properties, Rect) {
    var Square, SquareView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
    SquareView = (function(_super) {
      ...
      SquareView.prototype.init_glyph = function(glyphspec) {
        var glyph_props;
        glyph_props = new glyph_properties(this, glyphspec, ['x', 'y', 'size', 'angle'], {
          fill_properties: new fill_properties(this, glyphspec),
          line_properties: new line_properties(this, glyphspec)
        });
        return glyph_props;
    ...
    Square.prototype.display_defaults = _.clone(Square.prototype.display_defaults);
    _.extend(Square.prototype.display_defaults, {
      fill_color: 'gray',
      fill_alpha: 1.0,
      line_color: 'red',
      line_width: 1,
...
(function() {
  ...
  define('renderer/glyph/square_x',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var SquareX, SquareXView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
    ...
    SquareX.prototype.display_defaults = _.clone(SquareX.prototype.display_defaults);
    _.extend(SquareX.prototype.display_defaults, {
      fill_color: 'gray',
      fill_alpha: 1.0,
      line_color: 'red',
      line_width: 1,
...
(function() {
  ...
  define('renderer/glyph/square_cross',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var SquareCross, SquareCrossView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
    ...
    SquareCross.prototype.display_defaults = _.clone(SquareCross.prototype.display_defaults);
    _.extend(SquareCross.prototype.display_defaults, {
      fill_color: 'gray',
      fill_alpha: 1.0,
      line_color: 'red',
      line_width: 1,
...
(function() {
  ...
  define('renderer/glyph/segment',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Segment, SegmentView, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    SegmentView = (function(_super) {
      ...
      SegmentView.prototype.initialize = function(options) {
        var glyphspec;
        glyphspec = this.mget('glyphspec');
        this.glyph_props = new glyph_properties(this, glyphspec, ['x0', 'y0', 'x1', 'y1'], {
          line_properties: new line_properties(this, glyphspec)
        });
        this.do_stroke = this.glyph_props.line_properties.do_stroke;
...
(function() {
  ...
  define('renderer/glyph/text',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Text, TextView, glyph_properties, text_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    text_properties = Properties.text_properties;
    TextView = (function(_super) {
      ...
      TextView.prototype.initialize = function(options) {
        var glyphspec;
        glyphspec = this.mget('glyphspec');
        this.glyph_props = new glyph_properties(this, glyphspec, ['x', 'y', 'angle', 'text:string'], {
          text_properties: new text_properties(this, glyphspec)
        });
...
(function() {
  ...
  define('renderer/glyph/triangle',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Triangle, TriangleView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
...
(function() {
  ...
  define('renderer/glyph/wedge',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var Wedge, WedgeView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
...
(function() {
  ...
  define('renderer/glyph/x',["underscore", "renderer/properties", "./glyph"], function(_, Properties, Glyph) {
    var X, XView, fill_properties, glyph_properties, line_properties, _ref, _ref1;
    glyph_properties = Properties.glyph_properties;
    line_properties = Properties.line_properties;
    fill_properties = Properties.fill_properties;
...
(function() {
  define('common/plotting',["underscore", "jquery", "./plot", "range/data_range1d", "range/range1d", "renderer/annotation/legend", "renderer/glyph/glyph_factory", "renderer/guide/linear_axis", "renderer/guide/grid", "renderer/overlay/box_selection", "source/column_data_source", "tool/box_select_tool", "tool/pan_tool", "tool/preview_save_tool", "tool/resize_tool", "tool/zoom_tool"], function(_, $, Plot, DataRange1d, Range1d, Legend, GlyphFactory, LinearAxis, Grid, BoxSelection, ColumnDataSource, BoxSelectTool, PanTool, PreviewSaveTool, ResizeTool, ZoomTool) {
    ...
    create_glyphs = function(plot, glyphspecs, sources) {
      var glyph, glyphs, source, spec, val, _i, _j, _len, _len1, _ref;
      glyphs = [];
      ...
      if (sources.length === 1) {
        ...
        _ref = _.zip(glyphspecs, sources);
        for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
          val = _ref[_j];
          spec = val[0], source = val[1];
          glyph = GlyphFactory.Collection.create({
    ...
    add_axes = function(plot, xaxes, yaxes) {
      var a, axes, axis, loc, _i, _j, _len, _len1;
      axes = [];
      if (xaxes) {
        if (xaxes === true) {
          xaxes = ['min', 'max'];
      ...
      if (yaxes) {
        ...
        for (_j = 0, _len1 = yaxes.length; _j < _len1; _j++) {
          loc = yaxes[_j];
          axis = LinearAxis.Collection.create({
            dimension: 1,
            axis_label: 'y',
      ...
      return plot.add_renderers((function() {
        ...
        _results = [];
        for (_k = 0, _len2 = axes.length; _k < _len2; _k++) {
          a = axes[_k];
          _results.push(a.ref());
        }
        return _results;
    ...
    add_tools = function(plot, tools, glyphs, xdr, ydr) {
      var added_tools, g, pan_tool, preview_tool, resize_tool, select_overlay, select_tool, zoom_tool;
      if (tools === false) {
        return;
      }
      if (tools === true) {
    ...
    make_plot = function(glyphspecs, data, _arg) {
      var dims, g, glyphs, legend, plot, sources, title, tools, xaxes, xdr, xgrid, xrange, yaxes, ydr, ygrid, yrange;
      title = _arg.title, dims = _arg.dims, xrange = _arg.xrange, yrange = _arg.yrange, xaxes = _arg.xaxes, yaxes = _arg.yaxes, xgrid = _arg.xgrid, ygrid = _arg.ygrid, xdr = _arg.xdr, ydr = _arg.ydr, tools = _arg.tools, legend = _arg.legend;
      if (title == null) {
        title = "";
      }
      if (dims == null) {
