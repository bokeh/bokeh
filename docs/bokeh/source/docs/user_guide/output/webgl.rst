...
* all :ref:`fill properties <ug_basic_visuals_fill_properties>`
* all :ref:`line properties <ug_basic_visuals_line_properties>` except for
  dashed lines (which will be ignored)
* all :ref:`hatch properties <ug_basic_visuals_hatch_properties>` except for
