...
LaTeX on axis labels, titles, and labels
    ...
    .. bokeh-plot:: __REPO__/examples/basic/styling/math_text_latex_axis_labels_titles_labels.py
        :source-position: above
...
LaTeX and tick labels
    ...
    .. bokeh-plot:: __REPO__/examples/basic/styling/math_text_latex_tick_labels.py
        :source-position: above
...
LaTeX on RangeSlider and Slider widget titles
    ...
    .. bokeh-plot:: __REPO__/examples/basic/styling/math_text_latex_slider_widget_title.py
        :source-position: above
...
LaTeX with div and paragraph widgets
    ...
    .. bokeh-plot:: __REPO__/examples/basic/styling/math_text_latex_div_widget.py
        :source-position: above
...
.. bokeh-plot:: __REPO__/examples/basic/styling/math_text_mathml_axis_labels.py
    :source-position: above
