...
.. _ug_specialized_geo_tile_provider_maps:
...
.. bokeh-plot:: __REPO__/examples/specialized/geo/tile_source.py
...
.. bokeh-plot:: __REPO__/examples/specialized/geo/tile_xyzservices.py
    :source-position: below
...
.. _ug_specialized_geo_google_maps:
...
.. bokeh-plot:: __REPO__/examples/specialized/geo/gmap.py
    :source-position: below
...
.. _ug_specialized_geo_geojson_data:
...
.. bokeh-plot:: __REPO__/examples/specialized/geo/geojson_source.py
