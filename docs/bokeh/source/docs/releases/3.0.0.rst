...
* Django integration was moved to `bokeh_django`
...
``Tool.computed_overlays``
..........................

``Tool.computed_overlays`` was moved to ``ToolView.overlays``, to allow tool views
to provide additional overlays.
