''' A geogra plot that demonstrates how to use XYZ tile services to create an interactive map. The 'tile_xyz' service provides map tiles, 
which are typically used to display maps in web applications.The data used to create the plot is sourced from public XYZ tile services.
This example demonstrates how to create a plot in Bokeh with a map background using tile_providers.
