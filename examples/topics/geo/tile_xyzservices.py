...
The xyzservices library provides map tiles, which are typically used to display maps visualizations 
and geographical location in web applications. The data used to create the plot is 
sourced from public XYZ tile services. This example demonstrates how to create a plot in Bokeh
