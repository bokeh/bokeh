...
p = figure(title="A pyramid plot showing the age distribution of the male and female Titanic passengers", height=400, width=600,
           x_range=(-60, 40), x_axis_label="count", y_axis_label="age (years)")
