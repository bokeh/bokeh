...
(function() {
  var MAX_FREQ, NGRAMS, RadialHistogramPlot, SPECTROGRAM_LENGTH, SimpleXYPlot, SpectrogramApp, SpectrogramPlot, TILE_WIDTH, TIMESLICE, find, setup,
  ...
  SpectrogramApp = (function() {
    function SpectrogramApp(layout) {
      ...
      this.signal_plot = new SimpleXYPlot(find(layout, "signal"));
      this.power_plot = new SimpleXYPlot(find(layout, "spectrum"));
      this.freq_slider = find(layout, "freq");
      this.freq_slider.on("change:value", this.update_freq);
      this.gain_slider = find(layout, "gain");
    ...
    SpectrogramApp.prototype.on_data = function(data) {
      ...
      t = (function() {
        ...
        for (i = _i = 0, _ref = signal.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
          _results.push(i / signal.length * TIMESLICE);
        }
        return _results;
      })();
      ...
      f = (function() {
        ...
        for (i = _i = 0, _ref = spectrum.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
          _results.push(i / spectrum.length * MAX_FREQ);
        }
        return _results;
      })();
