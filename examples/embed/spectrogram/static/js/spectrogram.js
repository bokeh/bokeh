...
(function() {
  var RadialHistogramPlot, SimpleXYPlot, SpectrogramApp, SpectrogramPlot, find_glyph_renderer, setup, timer, _,
  ...
  SpectrogramApp = (function() {
    function SpectrogramApp(keys) {
      var config, item, key, models, _i, _len, _ref,
        _this = this;
      this.keys = keys;
