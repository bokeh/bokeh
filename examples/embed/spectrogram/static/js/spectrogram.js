...
(function() {
  var MAX_FREQ, NGRAMS, RadialHistogramPlot, SPECTROGRAM_LENGTH, SimpleXYPlot, SpectrogramApp, SpectrogramPlot, TILE_WIDTH, find, setup,
  ...
  SpectrogramApp = (function() {
    ...
    SpectrogramApp.prototype.on_data = function(data) {
      ...
      f = (function() {
        ...
        _results = [];
        for (i = _i = 0, _ref = signal.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
          _results.push(i / signal.length * MAX_FREQ);
        }
        return _results;
      })();
