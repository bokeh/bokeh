...
# scatter = Scatter(svalues, title="Scatter V Line", ylabel='measures',
#              legend=True, tools=TOOLS)
#
# int_point_line = Line(xyvalues, title="Lines Mouse Interp.", ylabel='measures',
#              tools=TOOLS)
# point_line = Line(xyvalues, title="Lines Mouse", ylabel='measures',
#              tools=TOOLS)
