...
from bokeh.objects import ColumnDataSource, Plot, DataRange1d, LinearAxis, Grid, GlyphRenderer, HoverTool, BoxSelectTool
...
class DataTables(object):
    ...
    def create(self):
        ...
        data_table = DataTable(source=self.source, columns=columns)
