...
cty = p.circle(x="index", y="cty", fill_color="#FDFF00", size=8, alpha=0.5, source=source)
hwy = p.circle(x="index", y="hwy", fill_color="#FF577F", size=8, alpha=0.5, source=source)
