...
cty = p.circle(x="index", y="cty", fill_color="#440154", size=8, alpha=0.5, source=source)
hwy = p.circle(x="index", y="hwy", fill_color="#AADB32", size=8, alpha=0.5, source=source)
