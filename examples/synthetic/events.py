...
from bokeh.models import ColumnDataSource, Range1d, Plot, LinearAxis, Grid, HoverTool, TapTool, WheelZoomTool, Legend, CustomJS
...
plot.add_layout(Legend(legends=[("CR1", [cr1]), ("CR2", [cr2, ln2]), ("CR3", [cr3])], location="center", orientation="vertical"))
plot.add_layout(Legend(legends=[("CR1", [cr1]), ("CR2", [cr2, ln2]), ("CR3", [cr3])], location="bottom_center", orientation="horizontal"))
plot.add_layout(Legend(legends=[("CR1", [cr1]), ("CR2", [cr2, ln2]), ("CR3", [cr3])], location="bottom_right", orientation="horizontal"))
...
if __name__ == "__main__":
    ...
    with open(filename, "w") as f:
        f.write(file_html(doc, INLINE, "events.py"))
