...
def intro():
    return Div(text="""
        ...
        <p>This is an example of <code>width_scale</code> mode (happy to continue the conversations
        about what to name the modes). In <code>width_scale</code> everything responds to the width
