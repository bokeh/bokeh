...
from bokeh.models import (
    ColumnDataSource, Plot, Circle, Range1d, LinearAxis, Legend,
...
fertility_df, life_expectancy_df, population_df_size, regions_df, years = process_data()
...
for year in years:
    ...
    new_df = pd.concat([fertility, life, population, region_color, region_name], axis=1)
