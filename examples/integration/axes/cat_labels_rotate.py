...
p1.x_axis.major_label_orientation = 1.2
p1.x_axis.group_label_orientation = "normal"
...
p2.x_axis.major_label_orientation = 1.2
p2.x_axis.subgroup_label_orientation = "vertical"
p2.x_axis.group_label_orientation = 0.8
