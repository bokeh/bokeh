...
Such as annular wedge, annulus, arc, bezier, circle, ellipse, Hbar, line, 
multi_line, multi_polygons, patch, patches, quad, quadratic, ray, rect, scatter.

.. bokeh-example-metadata::
    :apis: bokeh.plotting.figure.annular_wedge, bokeh.plotting.figure.annulus, bokeh.plotting.figure.arc, bokeh.plotting.figure.bezier, bokeh.plotting.figure.circle, bokeh.plotting.figure.ellipse, bokeh.plotting.figure.hbar, bokeh.plotting.figure.line, bokeh.plotting.figure.multi_line, bokeh.plotting.figure.multi_polygon, bokeh.plotting.figure.patch, bokeh.plotting.figure.patches, bokeh.plotting.figure.quad, bokeh.plotting.figure.quadratic, bokeh.plotting.figure.ray, bokeh.plotting.figure.rect, bokeh.plotting.figure.scatter
