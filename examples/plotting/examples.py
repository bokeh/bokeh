...
ray(x, y, 45, -0.7, color="#8888ee", tools="pan,zoom,resize")
quad(x, x-0.5, y, y-0.5, color="#8888ee", tools="pan,zoom,resize")
# quad_curve(y, y-1, x, x-1, color="#8888ee", tools="pan,zoom,resize")
rects(x, y, 10, 20, -0.7, color="#8888ee", tools="pan,zoom,resize")
segment(x, y, x-0.1, y-0.1, color="#8888ee", tools="pan,zoom,resize")
