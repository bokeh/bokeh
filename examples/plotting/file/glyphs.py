...
bezier(x, y, x+0.2, y, x+0.1, y+0.1, x-0.1, y-0.1, 
       color="#8888ee", tools="pan,zoom,resize", title="bezier")
circle(x, y, radius=0.1, radius_units="data", color="#8888ee", 
       tools="pan,zoom,resize", title="circle")
line(x, y, color="#8888ee", tools="pan,zoom,resize", title="line")
multi_line([xpts+xx for xx in x], [ypts+yy for yy in y], 
           color="#8888ee", tools="pan,zoom,resize", title="multi_line")
...
patches([xpts+xx for xx in x], [ypts+yy for yy in y], 
        color="#8888ee", tools="pan,zoom,resize", title="patches")
quad(x, x-0.5, y, y-0.5, 
     color="#8888ee", tools="pan,zoom,resize", title="quad")
quadratic(x, y, x+0.2, y, x+0.1, y+0.1, 
          color="#8888ee", tools="pan,zoom,resize", title="quadratic")
...
square(x, y, size=dict(field="sizes", units="screen"), color="#8888ee",
       ...
       tools="pan,zoom,resize", title="square")
wedge(x, y, 15, 0.6, 4.1, radius_units="screen", 
