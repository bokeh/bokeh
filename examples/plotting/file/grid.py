...
aw = annular_wedge(
    ...
    color="#8888ee", tools="pan,zoom,resize, crosshair", title="annular_wedge",
    name="glyphs_example", width=width, height=height)
bez = bezier(x, y, x+0.2, y, x+0.1, y+0.1, x-0.1, y-0.1,
       color="#8888ee", tools="pan,zoom,resize, crosshair", title="bezier",
       width=width, height=height)
q = quad(x, x-0.5, y, y-0.5,
     color="#8888ee", tools="pan,zoom,resize, crosshair", title="quad",
     width=width, height=height)
gridplot([[l,aw],[bez,q]])
