...
.. bokeh-example-metadata::
    :apis: bokeh.plotting.Figure.circle, bokeh.models.ColumnDataSource, bokeh.models.annotations.ColorBar,
           bokeh.models.mappers.LinearColorMapper, bokeh.models.mappers.LogColorMapper,
