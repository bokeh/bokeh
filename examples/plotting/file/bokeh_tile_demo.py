...
map_center_lat_lon = ( 51.477923,-0.001470 ) # Prime Meridian, Greenwich England

dE = 500 # (m) Easting  plus-and-minus from map center
dN = 500 # (m) Northing plus-and-minus from map center
