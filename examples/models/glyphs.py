...
glyphs = [
    ("annular_wedge", AnnularWedge(
        x="x", y="y", inner_radius=10, inner_radius_units="screen", outer_radius=20,
        outer_radius_units="screen", start_angle=0.6, end_angle=4.1, fill_color="#8888ee",
    )),
    ("annulus", Annulus(x="x", y="y", inner_radius=10, inner_radius_units="screen", outer_radius=20, outer_radius_units="screen", fill_color="#7FC97F")),
    ("arc", Arc(x="x", y="y", radius=20, radius_units="screen", start_angle=0.6, end_angle=4.1, line_color="#BEAED4", line_width=3)),
    ...
    ("ellipse", Ellipse(x="x", y="y", width=15, width_units="screen", height=25, height_units="screen", angle=-0.7, fill_color="#1D91C0")),
    ...
    ("rect", Rect(x="x", y="y", width=10, width_units="screen", height=20, height_units="screen", angle=-0.7, fill_color="#CAB2D6")),
    ("segment", Segment(x0="x", y0="y", x1="xm01", y1="ym01", line_color="#F4A582", line_width=3)),
    ("text", Text(x="x", y="y", text=value("hello"))),
    ("wedge", Wedge(x="x", y="y", radius=15, radius_units="screen", start_angle=0.6, end_angle=4.1, fill_color="#B3DE69")),
]
