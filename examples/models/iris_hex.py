...
# from bokeh.models.glyphs import Hexagon
from bokeh.models.glyphs import Hexagon, Square
...
# Hexagon = Square
hexagon = Hexagon(
    x="petal_length", y="petal_width", size=15,
    fill_color="color", fill_alpha=0.2, line_color="color"
)
plot.add_glyph(source, hexagon)
...
if __name__ == "__main__":
    filename = "iris_hex.html"
    with open(filename, "w") as f:
        f.write(file_html(doc, Resources(mode='absolute-dev'), "Iris Data Scatter Example"))
