...
(function () {
    ...
    if (this.gloo2 === undefined) {
        this.gloo2 = {};
    }
    this.gloo2.Buffer = Buffer;
    this.gloo2.GlooObject = GlooObject;
    this.gloo2.IndexBuffer = IndexBuffer;
    this.gloo2.Program = Program;
    this.gloo2.Texture2D = Texture2D;
    this.gloo2.VertexBuffer = VertexBuffer;
    this.gloo2.check_error = check_error;
})();
