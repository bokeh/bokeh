declare namespace Bokeh {
    ...
    export var FixedTicker: { new(attributes?: IFixedTicker, options?: KeyVal): FixedTicker };
    ...
    export var AdaptiveTicker: { new(attributes?: IAdaptiveTicker, options?: KeyVal): AdaptiveTicker };
    ...
    export var CompositeTicker: { new(attributes?: ICompositeTicker, options?: KeyVal): CompositeTicker };
    ...
    export var SingleIntervalTicker: { new(attributes?: ISingleIntervalTicker, options?: KeyVal): SingleIntervalTicker };
    ...
    export var DaysTicker: { new(attributes?: IDaysTicker, options?: KeyVal): DaysTicker };
    ...
    export var MonthsTicker: { new(attributes?: IMonthsTicker, options?: KeyVal): MonthsTicker };
    ...
    export var YearsTicker: { new(attributes?: IYearsTicker, options?: KeyVal): YearsTicker };
