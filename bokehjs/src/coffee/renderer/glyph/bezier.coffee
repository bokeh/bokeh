...
define [
  ...
  class BezierView extends Glyph.View
    ...
    _map_data: () ->
      ...
      [@scx0, @scy0] = @plot_view.map_to_screen(@cx0, @glyph_props.cx0.units, @cy0, @glyph_props.cy0.units, @x_range_name, @y_range_name)
      [@scx1, @scy1] = @plot_view.map_to_screen(@cx1, @glyph_props.cx1.units, @cy1, @glyph_props.cy1.units, @x_range_name, @y_range_name)
