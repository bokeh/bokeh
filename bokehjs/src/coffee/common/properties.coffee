define [
  ...
  class Enum extends Property
    ...
    validate: (value, attr) ->
      if value not in @levels
        throw new Error("enum property '#{attr}' given invalid value: #{value}, valid values are: #{@levels}")
  ...
  class Line extends ContextProperties
    ...
    initialize: (attrs, options) ->
      ...
      @join = new Enum({obj: obj, attr: "#{prefix}line_join", values: "miter round bevel"})
      @cap = new Enum({obj: obj, attr: "#{prefix}line_cap", values: "butt round square"})
    ...
    warm_cache: (source) ->
      super(source, ["color", "width", "alpha", "join", "cap", "dash", "dash_offset"])
  ...
  class Text extends ContextProperties
    ...
    initialize: (attrs, options) ->
      ...
      @font_style = new Enum({obj: obj, attr: "#{prefix}text_font_style", values: "normal italic bold"})
      @color = new Color({obj: obj, attr: "#{prefix}text_color"})
      @alpha = new Numeric({obj: obj, attr: "#{prefix}text_alpha"})
      @align = new Enum({obj: obj, attr: "#{prefix}line_align", values: "left right center"})
      @baseline = new Enum({obj: obj, attr: "#{prefix}line_baseline", values: "top middle bottom alphabetic hanging"})
  ...
  fields = (model, attr="fields") ->
    ...
    for field in model[attr]
      ...
      switch type
        ...
        when "direction" then result[field] = new Direction({obj: model, attr: field})
        when "enum" then result[field] = new Enum({obj: model, attr: field, values:arg})
