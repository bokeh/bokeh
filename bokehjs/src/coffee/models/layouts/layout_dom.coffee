  ...
  get_constrained_variables: () ->
    if @get('grow')
      ...
      vars = {
        ...
        # TODO This only helps us in vertical arrangements 
        # Need to do something better - but need to know whether parent is a
        # row or a column (or rather the logic needs to be up a level)
