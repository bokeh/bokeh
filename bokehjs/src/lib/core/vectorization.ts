...
export function value<const T>(value: T): Value<T>
export function value<T, In>(value: T, transform: Transform<In, T>): Value<T>
export function value<T, Units>(value: T, modifiers: SpecModifiers<T, Units>): Value<T, Units>
export function value<T, Units = never>(value: T, arg: object = {}): Value<T, Units> {
  return {type: "value", value, ...spec_modifiers(arg)}
}

export function field<T = never>(value: string): Field<T>
export function field<In, T>(value: string, transform: Transform<In, T>): Field<T>
export function field<T, Units>(value: string, modifiers: SpecModifiers<T, Units>): Field<T, Units>
...
export function expr<T>(value: Expression<T>): Expr<T>
export function expr<T, In>(value: Expression<T>, transform: Transform<In, T>): Expr<T>
export function expr<T, Units>(value: Expression<T>, modifiers: SpecModifiers<T, Units>): Expr<T, Units>
