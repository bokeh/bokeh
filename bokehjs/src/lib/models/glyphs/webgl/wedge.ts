...
export class WedgeGL extends SingleMarkerGL {
  constructor(regl_wrapper: ReglWrapper, override readonly glyph: WedgeView) {
    super(regl_wrapper, glyph)
  }

  override draw(indices: number[], main_glyph: WedgeView, transform: Transform): void {
    this._draw_impl(indices, transform, main_glyph.glglyph!, "wedge")
  }
  ...
  protected override _set_data(): void {
    ...
    if (this._centers == null) {
      ...
      //this._start_angles = new Float32Buffer(this.regl_wrapper)
      //this._end_angles = new Float32Buffer(this.regl_wrapper)
    }
