require ["numeral"], (numeral) ->
  ...
  test 'numeral number formatting', () ->
    tests = [
    ...
    for [value, format, result] in tests
      equal(numeral.format(value, format), result)

  test 'numeral currency formatting', () ->
    tests = [
  ...
  test 'numeral percentage formatting', () ->
    tests = [
      [1,           '0%',         '100%']
  ...
  test 'numeral rounding', () ->
    ...
    for [value, format, floor_result, ceil_result] in tests
      equal(numeral.format(value, format, null, Math.floor), floor_result)
      equal(numeral.format(value, format, null, Math.ceil), ceil_result)
