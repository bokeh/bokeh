...
describe "SelectTool module", ->
  ...
  describe "SelectTool.Model", ->
    ...
    describe "SelectTool._get_cb_data method", ->
    ...
    describe "SelectTool._save_geometry", ->
