...
describe("CustomJSFilter", () => {
  ...
  describe("default creation", () => {
    const filter = new CustomJSFilter({use_strict: true})
  ...
  describe("values property", () => {
    ...
    it("should contain the args values in order", () => {
      ...
      const filter = new CustomJSFilter({args: {foo: rng1, bar: rng2}, use_strict: true})
  ...
  describe("func property", () => {
    ...
    it("should have code property as function body", () => {
      const filter = new CustomJSFilter({code: "return 10", use_strict: true})
    ...
    it("should have values as function args", () => {
      ...
      const filter = new CustomJSFilter({args: {foo: rng.ref()}, code: "return 10", use_strict: true})
  ...
  describe("compute_indices", () => {
    ...
    it("should execute the code and return the result", () => {
      const filter = new CustomJSFilter({code: "return [0]", use_strict: true})
