...
describe("GroupFilter", () => {
  ...
  describe("compute_indices", () => {
    ...
    it("returns the correct indices when column_name is in the data source", () => {
      const group_filter = GroupFilter.create({column_name: "x", group: "a"})
