...
describe("core/util/color module", () => {
  ...
  it("should provide the given alpha value", () => {
    expect(color2rgba("#ff0000", 0.1)).to.be.equal([255, 0, 0, 26])
    expect(color2rgba("#ff0000", 0.5)).to.be.equal([255, 0, 0, 128])
    expect(color2rgba("#0f0", 0.5)).to.be.equal([0, 255, 0, 128])
    expect(color2rgba("blue", 0.5)).to.be.equal([0, 0, 255, 128])
  })
  ...
  it("should turn rgba() colors to tuples, overriding alpha", () => {
    ...
    expect(color2rgba("rgba(255, 0, 0, 1.0)", 0.5)).to.be.equal([255, 0, 0, 128])
    expect(color2rgba("rgba(255, 0, 0, 0.4)", 0.5)).to.be.equal([255, 0, 0, 102])
  })
