...
import {Ascii, LinearAxis, LinearScale, MathML, PlainText, Plot, Range1d, TeX} from "@bokehjs/models"
...
describe("models with MathText", () => {
  ...
  it.skip("should support LaTeX notation on axis_label strings", async () => {
    const stub = sinon.stub(MathTextView.prototype, "provider")
    stub.value(new InternalProvider())
    try {
  ...
  it.skip("should ignore LaTeX notation on axis_label with string and $ signs using PlainText", async () => {
    const stub = sinon.stub(MathTextView.prototype, "provider")
    stub.value(new InternalProvider())
    try {
  ...
  it.skip("should support LaTeX notation on axis_label with MathText", async () => {
    const stub = sinon.stub(MathTextView.prototype, "provider")
    stub.value(new InternalProvider())
    try {
  ...
  it.skip("should support Ascii notation on axis_label with MathText", async () => {
    const stub = sinon.stub(MathTextView.prototype, "provider")
    stub.value(new InternalProvider())
    try {
  ...
  it.skip("should support MathML notation on axis_label with MathText", async () => {
    const stub = sinon.stub(MathTextView.prototype, "provider")
    stub.value(new InternalProvider())
    try {
  ...
  it.skip("should support LaTeX notation on axis_label with MathText and a delay in loading", async () => {
    const stub = sinon.stub(MathTextView.prototype, "provider")
  ...
  it.skip("should support LaTeX notation on axis_label with MathText and fallback to text if MathJax has errors", async () => {
    const stub = sinon.stub(MathTextView.prototype, "provider")
  ...
  it.skip("should display tick labels with MathText on overrides", async () => {
    const stub = sinon.stub(MathTextView.prototype, "provider")
    stub.value(new InternalProvider())
    try {
      await plot({
