  ...
  it("should support Trefoil", async () => {
    ...
    function trefoil(R: number = 1) {
      const p = figure({
        ...
        title: Title.create({text: "Radiation Warning Symbol (Trefoil)", align: "center", text_font_size: "20px"}),
      ...
      arc.add_decoration(TeeHead.create({size: 10}), "start")
      arc.add_decoration(VeeHead.create({size: 8}), "start")
      arc.add_decoration(TeeHead.create({size: 10}), "end")
      arc.add_decoration(VeeHead.create({size: 8}), "end")
      ...
      s.add_decoration(TeeHead.create({size: 10}), "start")
      s.add_decoration(VeeHead.create({size: 8}), "start")
      s.add_decoration(TeeHead.create({size: 10}), "end")
      s.add_decoration(VeeHead.create({size: 8}), "end")
