...
const plot = Plotting.figure({title: "BokehJS Web Component", width: 560, height: 300})
plot.line({field: "x"}, {field: "y"}, {source, line_width: 3})

document.querySelector("#app")!.innerHTML = `
  <main class="app-shell">
    <p class="eyebrow">Web Component example</p>
    <h1>BokehJS custom element</h1>
    <p class="intro">A native DOM control updates data rendered by a Bokeh custom element.</p>
...
element.model = plot
document.querySelector("#plot")!.append(element)
