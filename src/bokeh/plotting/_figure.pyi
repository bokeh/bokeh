...
class figure(Plot, GlyphAPI):
    ...
    def harea_stack(self, stackers: SequenceLike[str], **kwargs: Any) -> list[GlyphRenderer[HArea]]: ...

    def varea_stack(self, stackers: SequenceLike[str], **kwargs: Any) -> list[GlyphRenderer[VArea]]: ...

    def hbar_stack(self, stackers: SequenceLike[str], **kwargs: Any) -> list[GlyphRenderer[HBar]]: ...

    def vbar_stack(self, stackers: SequenceLike[str], **kwargs: Any) -> list[GlyphRenderer[VBar]]: ...

    def hline_stack(self, stackers: SequenceLike[str], **kwargs: Any) -> list[GlyphRenderer[Line]]: ...

    def vline_stack(self, stackers: SequenceLike[str], **kwargs: Any) -> list[GlyphRenderer[Line]]: ...
