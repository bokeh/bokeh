...
class Plot(LayoutDOM, BackgroundFill, BackgroundHatch, BorderFill, BorderHatch, OutlineLine):
    ...
    left: list[StyledElement] = ...

    right: list[StyledElement] = ...

    above: list[StyledElement] = ...

    below: list[StyledElement] = ...

    center: list[StyledElement] = ...
    ...
    def add_layout(self, obj: StyledElement, place: Place = "center") -> None: ...
