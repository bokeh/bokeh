...
class _StaticLayoutProviderInit(_ModelInit, total=False):
...
class _NodeCoordinatesInit(_CoordinateTransformInit, total=False):
    layout: LayoutProvider

class NodeCoordinates(GraphCoordinates):
    def __init__(self, **kwargs: Unpack[_NodeCoordinatesInit]) -> None: ...

class _EdgeCoordinatesInit(_CoordinateTransformInit, total=False):
    layout: LayoutProvider
