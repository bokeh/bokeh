...
class _OpenHeadInit(_MarkingInit, _LinePropsInit, total=False):
    size: NumberSpec

class OpenHead(ArrowHead, LineProps):
    ...

class _NormalHeadInit(_MarkingInit, _LinePropsInit, _FillPropsInit, _HatchPropsInit, total=False):
    size: NumberSpec

class NormalHead(ArrowHead, LineProps, FillProps, HatchProps):
    ...

class _TeeHeadInit(_MarkingInit, _LinePropsInit, total=False):
    size: NumberSpec

class TeeHead(ArrowHead, LineProps):
    ...

class _VeeHeadInit(_MarkingInit, _LinePropsInit, _FillPropsInit, _HatchPropsInit, total=False):
    size: NumberSpec
