...
class _TextAnnotationInit(_AnnotationInit, _ScalarTextPropsInit, _ScalarBackgroundFillPropsInit, _ScalarBackgroundHatchPropsInit, _ScalarBorderLinePropsInit, total=False):
    text: TextLike
    padding: Padding
...
class _LabelInit(_AnnotationInit, _ScalarTextPropsInit, _ScalarBackgroundFillPropsInit, _ScalarBackgroundHatchPropsInit, _ScalarBorderLinePropsInit, total=False):
    text: TextLike
    padding: Padding
    border_radius: BorderRadius
    anchor: TextAnchor
...
class _TitleInit(_AnnotationInit, _ScalarTextPropsInit, _ScalarBackgroundFillPropsInit, _ScalarBackgroundHatchPropsInit, _ScalarBorderLinePropsInit, total=False):
    text: TextLike
    padding: Padding
    border_radius: BorderRadius
