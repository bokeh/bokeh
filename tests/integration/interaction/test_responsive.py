...
def make_responsive_plot(plot_width, plot_height, responsive_mode='scale_width'):
...
def test_responsive_resizes_plot_while_maintaining_aspect_ratio(output_file_url, selenium):
    ...
    plot = make_responsive_plot(plot_width, plot_height, responsive_mode='scale_width')
    save(plot)
...
def test_responsive_maintains_a_minimum_width(output_file_url, selenium):
    ...
    plot = make_responsive_plot(600, 1200, responsive_mode='scale_width')
    save(plot)
...
def test_responsive_maintains_a_minimum_height(output_file_url, selenium):
    ...
    plot = make_responsive_plot(1200, 600, responsive_mode='scale_width')
    save(plot)
...
def test_responsive_plot_starts_at_correct_size(output_file_url, selenium):
    plot = make_responsive_plot(600, 600, responsive_mode='scale_width')
    save(plot)
...
def test_box_responsive_plot_is_not_taller_than_page(output_file_url, selenium):
    ...
    plot = make_responsive_plot(200, 200, responsive_mode='stretch_both')
    save(plot)
