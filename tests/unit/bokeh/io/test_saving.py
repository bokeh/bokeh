...
def test__get_save_args_explicit_filename():
    filename, resources, title = bis._get_save_args(
        curstate(), "filename", "resources", "title"
    )
...
def test__get_save_args_default_title():
    ...
    filename, resources, title = bis._get_save_args(
        curstate(), "filename", "resources", None
    )
    assert title == "title"
