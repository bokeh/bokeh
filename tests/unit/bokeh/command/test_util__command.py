...
class Test_set_single_width_height:
    def test_neither(self) -> None:
        p = figure(width=200, height=300)
        d = Document()
        d.add_root(p)
        util.set_single_width_height(d, None, None)
        assert p.width == 200
        assert p.height == 300
    ...
    def test_width(self) -> None:
        ...
        d = Document()
        d.add_root(p)
        util.set_single_width_height(d, 400, None)
        assert p.width == 400
        assert p.height == 300
    ...
    def test_height(self) -> None:
        ...
        d = Document()
        d.add_root(p)
        util.set_single_width_height(d, None, 400)
        assert p.width == 200
        assert p.height == 400
    ...
    def test_both(self) -> None:
        ...
        d = Document()
        d.add_root(p)
        util.set_single_width_height(d, 400, 500)
        assert p.width == 400
        assert p.height == 500
