...
# TODO rect2 = Rect(x=2, y=2, width=1, height=1, fill_color=Spectral7[2], border_radius=SimpleNamespace(top_left=30, top_right=20, bottom_right=10))
# TODO rect3 = Rect(x=3, y=3, width=1, height=1, fill_color=Spectral7[3], border_radius=struct(top_left=30, top_right=20, bottom_right=10))
